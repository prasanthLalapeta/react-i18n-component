...
const MESSAGES_PATTERN = "./translation/messages/**/*.json";
const LANG_DIR = "./translation/locales/";
const LANG_PATTERN = "./translation/locales/*.json";

// Try to delete current json files from locales
try {
  fs.unlinkSync("./translation/locales/data.json");
} catch (error) {
  console.log(error);
}
